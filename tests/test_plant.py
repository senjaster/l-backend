...
def test_concurrent_modification_detected(client: TestClient, plant_data):
    ...
    plant_data["server_modified_at"] = "2020-01-01T00:00:00Z"  # Wrong timestamp
    plant_data["name"] = "Updated Name"
...
def test_extra_facilities_deleted_with_force(client: TestClient, plant_data, facility_id_2):
    ...
    facility_1 = next((f for f in data["facilities"] if f["id"] == plant_data["facilities"][0]["id"]), None)
...
def test_missing_timestamp_for_update(client: TestClient, plant_data):
    ...
    plant_data["server_modified_at"] = "2020-01-01T00:00:00Z"  # Old timestamp
    plant_data["name"] = "Updated Name"
...
def test_is_deleted_honored_for_plant(client: TestClient, plant_data):
    ...
    plant_data["is_deleted"] = True  # Explicitly set as deleted
    plant_data["facilities"] = []
...
def test_is_deleted_honored_for_facility(client: TestClient, plant_data, facility_id_2):
    ...
    facility_1_retrieved = next((f for f in retrieved_data["facilities"] if f["id"] == plant_data["facilities"][0]["id"]), None)
...
def test_mismatched_child_ids_rejection(client: TestClient, plant_data, facility_id_1, facility_id_2, facility_id_3):
...
def test_force_mode_with_stealing_attempt(client: TestClient, plant_data, facility_id_1):
    ...
    plant_data_2["id"] = str(plant_id_2)
    plant_data_2["name"] = "Plant Two"
    plant_data_2["facilities"][0]["id"] = str(facility_id_1)  # Steal facility
...
def test_empty_facilities_list_with_force(client: TestClient, plant_data, facility_id_1, facility_id_2):
...
def test_multiple_facility_operations_in_single_request(client: TestClient, plant_data, facility_id_1, facility_id_2, facility_id_3):
