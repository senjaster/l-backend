-- name: create_refresh_token(id, inspector_id, device_id, token_hash, expires_at)<!
...
-- name: update_password(new_password_hash,old_password_hash,id)^
...
-- name: revoke_all_tokens_for_inspector(inspector_id)!
UPDATE lesiv.tokens
SET revoked = TRUE
